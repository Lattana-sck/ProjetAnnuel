          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                ...
                <MobileNavItem href="/finance_yourself">Se financer</MobileNavItem>
                <MobileNavItem href="/marketplace">Marketplace</MobileNavItem>
                <MobileNavItem href="/roadmap">Roadmap</MobileNavItem>
                <MobileNavItem href="/faq">FAQ & guides</MobileNavItem>
                <MobileNavItem href="/register">Inscription</MobileNavItem>
                <MobileNavItem href="/login">Connexion</MobileNavItem>
              </ul>
            </nav>
          </Popover.Panel>
        </Transition.Child>
